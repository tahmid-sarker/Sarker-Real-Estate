    ...
    <>
      <div className={`${darkMode ? "dark bg-black" : "light bg-white"}`}>
        ...
        >
          ...
          >
            Find your next Home in Sylhet
          </h1>
          <p
            data-aos="zoom-in"
            className="text-white text-xl lg:pr-[500px] pr-0"
          >
            Discover the beauty of Sylhet and find your dream home with us. Our
            platform revolutionizes the way agents and clients navigate the
      ...
      >
        <div
          ...
          } lg:w-[70%] w-full m-auto
        grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-6 p-8 rounded-xl -mt-14`}
        >
          ...
          <div className="w-full">
            ...
            <select
              name="selectOption"
              id="selectOption"
              className="bg-white p-2 w-full mt-2 border-b-[1px] border-[#c9c7c1] text-gray-500 text-md"
            >
